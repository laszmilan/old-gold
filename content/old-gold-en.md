...
At least one polyhedral (d4, d6, d8, d10, d12, d20) dice set, paper, pencil, and the provided game sheets. The character sheet's inventory slots are sized for 50×15mm sticky notes, so items can be moved or discarded easily.
...
- **Solo play.** Control a party of adventurers and explore the world through your imagination and oracles.
- **Group play.** Each player controls one or more PCs to shape the fiction and overcome challenges together.
- **Guided play.** One player serves as the Referee, describing the world, NPCs, and arbitrating the rules.
...
Four attributes ranging from 0 to 9 measure your PC's strengths and weaknesses. Each attribute has a score and a bonus (half the score, rounded up). Scores are used for checks and to calculate maximum HP, while bonuses are used for everything else (damage, range, magical effects, and in any other formula).
...
| 1d12 | Dwarf | Elf | Human | Halfkin |
|---|---|---|---|---|
| 1 | Járnda | Varenthas | Garric | Bramble |
| 2 | Vrannik | Celindyl | Mara | Sedge |
| 3 | Grudnir | Fendalus | Eirik | Poppy |
| 4 | Kelvor | Therylon | Hegwin | Nettle |
| 5 | Stennig | Nyveris | Seren | Thistle |
| 6 | Ongdur | Seralyn | Treven | Flint |
| 7 | Feldar | Maeraphon | Connig | Tansy |
| 8 | Hegril | Evrandir | Aldwen | Moss |
| 9 | Dáli | Aelinor | Haldric | Mallow |
| 10 | Brúni | Galrion | Brynn | Rue |
| 11 | Midrik | Yphera | Wynna | Sorrel |
| 12 | Andveg | Abrion | Drystan | Clover |
...
| Mirror | 1 slot. | 10 |
| Caltrops | 1 slot, 2m radius. Creatures crossing take 1d4 and halve speed. | 15 |
| Hunting trap | 1 slot. 1d6 damage and halts movement. Advantage when foraging. | 30 |
| Manacles | 1 slot. | 20 |
...
**Retrying.** You cannot retry a failed check unless the circumstances change: new tools, new information, a different approach, or enough time for the situation to shift.
...
When precision matters, time can be measured in these scales.
...
At a breaking point (first casualty, half their number dead, leader slain, facing something terrifying) NPCs must check morale. Roll 2d6; if the result exceeds their morale score, they flee, surrender, or retreat.
...
Both spells and prayers require a main action, a free hand, and the ability to speak. Mark a usage dot when you cast, and clear all dots after a successful rest.
...
Old Gold's overland play happens on a hex map where each hex represents 10 km of terrain. The map can be the Referee's, drawn from a published setting, or generated however your table prefers.

Crossing a hex takes a watch and reveals what's on the surface: terrain, roads, landmarks, settlements, and anything that isn't trying to hide. Difficult terrain (mountains, swamps, dense forest) takes 2 watches to cross, while roads let you cross 2 hexes per watch or 1 hex per watch through difficult terrain. Some terrain features (rivers, cliffs, mountain spines) are dangerous to cross and might require appropriate checks.
...
| 4–5 | Weather shifts unfavorably. |
| 6–8 | Nothing eventful. |
| 9–10 | Weather shifts favorably. |
...
| Mule | 10 | — | 50 |
| Horse | 15 | — | 250 |
| Cart | 25 | 2 mule or horse | 100 |
| Wagon | 50 | 4 mule or horse | 500 |
...
Vehicles requiring crew won't move without sufficient crew aboard, and hirelings cost their daily wages on top of the purchase price.
...
PCs usually move through dungeons one room per turn. Most of this time is spent testing surfaces, listening, and mapping, therefore visible features and clues are revealed automatically. Searching a room can reveal hidden details but may require a check and spending an extra turn, depending on what you seek.
...
**Running.** Characters who run can cover up to 6 rooms per turn, but cannot map, automatically trigger traps, and are surprised by all encounters.
...
When the party encounters a creature unexpectedly, determine their number, distance, and reaction. Distance is 2d6 × 2m in dungeons or 2d6 × 20m in wilderness. If their reaction isn't obvious, consult the Reaction Oracle.
...
| 9–10 | Neutral. Ignores or passes by. |
...
**Running a business.** A business or investment typically generates an annual profit equal to 2d6% of its initial investment cost, provided operations proceed smoothly and without disruption.
...
These costs represent a full day of meals and drinks.
...
When a question about the world has no clear answer (Will the bridge hold? Am I alone here?) frame it as a yes or no question and roll 1d6.
...
| 7 | Fugitive | A monster stalks the road | It must remain a secret |
| 8 | Elderly recluse | A curse must be broken | The client is the real villain |
| 9 | Cartographer | A prisoner needs freeing | The reward is cursed |
